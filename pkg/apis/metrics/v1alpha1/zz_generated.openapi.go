...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/aerogear/app-metrics-operator/pkg/apis/metrics/v1alpha1.AppMetricsConfig":        schema_pkg_apis_metrics_v1alpha1_AppMetricsConfig(ref),
		"github.com/aerogear/app-metrics-operator/pkg/apis/metrics/v1alpha1.AppMetricsConfigSpec":    schema_pkg_apis_metrics_v1alpha1_AppMetricsConfigSpec(ref),
		"github.com/aerogear/app-metrics-operator/pkg/apis/metrics/v1alpha1.AppMetricsConfigStatus":  schema_pkg_apis_metrics_v1alpha1_AppMetricsConfigStatus(ref),
...
func schema_pkg_apis_metrics_v1alpha1_AppMetricsConfig(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "AppMetricsConfig is the Schema for the appmetricsaconfigs API",
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/aerogear/app-metrics-operator/pkg/apis/metrics/v1alpha1.AppMetricsConfigSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/aerogear/app-metrics-operator/pkg/apis/metrics/v1alpha1.AppMetricsConfigStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/aerogear/app-metrics-operator/pkg/apis/metrics/v1alpha1.AppMetricsConfigSpec", "github.com/aerogear/app-metrics-operator/pkg/apis/metrics/v1alpha1.AppMetricsConfigStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_metrics_v1alpha1_AppMetricsConfigSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "AppMetricsConfigSpec defines the desired state of AppMetricsConfig",
				Properties:  map[string]spec.Schema{},
			},
		},
		Dependencies: []string{},
...
func schema_pkg_apis_metrics_v1alpha1_AppMetricsConfigStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "AppMetricsConfigStatus defines the observed state of AppMetricsConfig",
				Properties:  map[string]spec.Schema{},
			},
		},
		Dependencies: []string{},
