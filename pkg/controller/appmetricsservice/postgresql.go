...
func newPostgresqlPersistentVolumeClaim(cr *metricsv1alpha1.AppMetricsService) (*corev1.PersistentVolumeClaim, error) {
...
func newPostgresqlSecret(cr *metricsv1alpha1.AppMetricsService) (*corev1.Secret, error) {
	...
	return &corev1.Secret{
		...
		StringData: map[string]string{
			"POSTGRES_DATABASE":  "appmetrics",
			"POSTGRES_USERNAME":  "appmetrics",
...
func newPostgresqlDeploymentConfig(cr *metricsv1alpha1.AppMetricsService) (*openshiftappsv1.DeploymentConfig, error) {
...
func newPostgresqlService(cr *metricsv1alpha1.AppMetricsService) (*corev1.Service, error) {
